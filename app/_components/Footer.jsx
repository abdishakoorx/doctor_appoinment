...
function Footer() {
  return (
    <div>
    <footer className="mt-10 text-white bg-gray-900 ">
        <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
                <div className="flex justify-center text-teal-600 sm:justify-start dark:text-teal-300">
                <Image src="/logoDark.png" alt='logo' width={180} height={50} />
                </div>

                <p
                className="max-w-md mt-6 leading-relaxed text-center text-teal-600 sm:max-w-xs sm:text-left dark:text-gray-400"
                >
                Best doctors, Best services, Better Health.
                </p>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                ...
                <div className="text-center sm:text-left">
                    ...
                    <ul className="mt-8 space-y-4 text-sm">
                        ...
                        <li>
                        <a
                            className="group flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end"
                            href=""
                        >
                            <span
                            className="text-white transition group-hover:text-white/75 dark:text-white dark:hover:text-white/75"
                            >
                            Live Chat
                            </span>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                    ...
                    >
                        ...
                        className="text-white size-5 shrink-0 dark:text-white"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth="2"
                        ...
                        <span className="flex-1 text-white dark:text-gray-300"> abdishakoor145@gmail.com </span>
                    </a>
                    </li>
                    ...
                    >
                        ...
                        <span className="flex-1 text-white dark:text-gray-300">0123456789</span>
                    </a>
                    </li>
            ...
            <div className="pt-6 mt-12 border-t border-gray-100 dark:border-gray-800">
